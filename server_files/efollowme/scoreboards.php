<?php 
	...
	$query = "SELECT user.username,user.score FROM user ORDER by score DESC";
...
<head>
  <meta charset="UTF-8">
  <title>eFollowMe: Βαθμολογίες Παιχτών</title>
...
var res = JSON.parse( '<?php echo json_encode($rows); ?>' );
