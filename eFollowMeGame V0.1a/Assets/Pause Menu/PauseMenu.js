...
GUI.skin.button.font = pauseMenuFont;
	...
	if(pauseEnabled == true){
		...
		GUI.Box(Rect(Screen.width /2 - 100,Screen.height /2 - 100,250,150), "Pause Menu");
		
		//Make Main Menu button
		if(GUI.Button(Rect(Screen.width /2 - 100,Screen.height /2 - 50,250,50), "Back to Main Menu")){
